...
def main():
    ...
    if LOAD_MODEL:
        print('Loading Model...')
        checkpoint = torch.load(model_path + '/checkpoint.pth', weights_only=True)
        ...
        best_model_checkpoint = torch.load(model_path + '/best_model_checkpoint.pth', weights_only=True)
